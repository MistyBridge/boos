...
description: Curate auto-memory into durable project knowledge. Analyze MEMORY.md for patterns, promote learnings to CLAUDE.md and rules, extract solutions into reusable skills. Use when reviewing learned patterns, graduating notes to rules, turning debugging solutions into skills, or checking memory health.
---
