---
name: skill-idea
description: Mine Claude Code session logs for skill idea candidates. Extract, score, and backlog new skill ideas from recent coding sessions. Use when generating skill ideas or reviewing session history for automation opportunities.
---
