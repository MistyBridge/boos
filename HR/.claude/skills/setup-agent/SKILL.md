---
name: setup-agent
description: Set up a new agent configuration interactively. Collects domain, target file, eval command, metric, direction, and evaluator. Use when asked to configure or initialize a new agent.
---
