...
import { isMobile, mobileDrawerOpen, selectTab } from '../state.js';
import { IconSidebarToggle, IconClose, IconPlus } from '../icons.js';

const LS_POS = 'boos.fab.pos';
const FAB_SIZE = 52;
const SAFE_MARGIN = 8;
...
export function MobileNavFab() {
  ...
  return html`
    ...
    <button class="mobile-launch-fab"
            aria-label="新建会话"
            title="新建会话"
            onClick=${() => {
