...
//
// Stored in localStorage under `boos.keybindings` as `{ action: combo }`.
...
export const ACTIONS = {
  'session-next':      { label: T.keybindings.nextSession,    defaultCombo: 'Ctrl+Alt+ArrowDown' },
  'session-prev':      { label: T.keybindings.prevSession,    defaultCombo: 'Ctrl+Alt+ArrowUp' },
  'session-move-down': { label: T.keybindings.moveDown,       defaultCombo: 'Ctrl+Alt+Shift+ArrowDown' },
  'session-move-up':   { label: T.keybindings.moveUp,         defaultCombo: 'Ctrl+Alt+Shift+ArrowUp' },
};

const LS_KEY = 'boos.keybindings';
...
export function formatCombo(combo) {
  if (!combo) return T.keybindings.unset;
  return combo
    .replace(/ArrowUp/g, '↑')
    .replace(/ArrowDown/g, '↓')
    .replace(/ArrowLeft/g, '←')
