...
async function rebuildTaskIndex() {
  ...
  // Sprint 42: boundary marker — wakes for agents with pending tasks run
  // right after this; a crash here shows up as the last marker state.
  try { require('../crashForensics').note('queue-rebuild-done', { tasks: _taskIndex.size }); } catch {}
}
