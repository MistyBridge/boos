...
async function _checkWorkspace(workspace) {
  ...
  } catch (e) { errReport.report("autoSupervisor", "isAutoSupervisorEnabled", e); }
  ...
  try {
    ...
    if (disabledFolders.size > 0) {
      ...
      for (const a of agents) {
        ...
        } catch (e) { errReport.report("autoSupervisor", "add", e); }
      }
  ...
  } catch (e) { errReport.report("autoSupervisor", "has", e); }
  ...
  } catch (e) { errReport.report("autoSupervisor", "push", e); }
