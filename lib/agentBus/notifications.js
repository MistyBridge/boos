...
// ── Frontend activity bridge (Sprint 9/30) ──────────────────────────
// Set by routes/agents.js when the SSE channel comes online.
// Called with (boosSessionId, activity, meta?) where meta carries
// agent_uid + agent_name for UID-based correlation.
// Pushes agent-bus state changes to the frontend Agent Canvas in real time.
