...
const _taskOps = {
  ...
  async listMyTasks(uid) {
    // Sprint 39: inbox-only. Removed agent-bus.json fallback to prevent
    // phantom task entries from surfacing after server restart.
    return await inboxStore.listAllTasks(uid);
  },
};
