...
// call as "submit"; appending \n\r in the same write triggers the submit.
//
...
// ── PTY injection ──────────────────────────────────────────────────────
// Sprint 38 vFinal: Burst injection — `command + \n\r` written in a single
// pty.write() call. \n\r (LF+CR) triggers submit in Claude Code's Ink TUI.
// \n alone moves cursor down without submitting; \r alone in a separate
// write does nothing. The combination in ONE write is what works.
// bracketed-paste (\x1b[200~...\x1b[201~) wrapper is broken in Ink.
//
// Modes (BOOS_PTY_INJECT_MODE env):
//   burst  — all chars in one write, \n\r-terminated (DEFAULT ✓)
