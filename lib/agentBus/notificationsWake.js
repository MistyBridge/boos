...
// ── PTY injection ──────────────────────────────────────────────────────
// Sprint 38: Bracketed-paste injection — wraps command in \x1b[200~ ...
// \x1b[201~ (terminal bracketed paste mode). Most TUI apps (including
// Ink-based ones) auto-submit pasted content that ends with \r.
// Falls back to plain \r append if env BOOS_PTY_PASTE_MODE=0.

const WAKE_COMMAND = 'check_inbox[BOOS]';  // fallback when no task context
const PASTE_START = '\x1b[200~';
const PASTE_END   = '\x1b[201~';
const USE_PASTE_MODE = process.env.BOOS_PTY_PASTE_MODE !== '0';  // default on
...
// Bracketed-paste injection: \x1b[200~ <command> \r \x1b[201~
// The terminal tells the app "this is pasted content". Most apps
// auto-submit paste content that ends with a newline/carriage-return.
