...
//
// The PMO is the PM's workload partner and failover. It polls workspace
// health on-demand (via pmo_poll MCP tool), tracks PM responsiveness,
// and escalates to human decision area when the PM is unresponsive.
//
// Integration: handlersDag._pmoPoll → pmoEngine.poll(workspace)
//
// Design constraints:
...
/**
 * Poll workspace health. Called by PMO agent via pmo_poll MCP tool.
 *
