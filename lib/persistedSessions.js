...
/**
 * @deprecated Sprint 13: Prefer store.getIdentity({ name, workspace }) or
 *   store.getIdentityByBoosSession() for deterministic session lookup via
 *   the identity card system. This heuristic remains as a legacy fallback
 *   for agents without identity cards (pre-migration).
 */
