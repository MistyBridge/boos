...
function loadRoleTemplates() {
  ...
  try {
    ...
    for (const file of files) {
      ...
      } catch (e) { errReport.report("hrAgent_index", "parse", e); }
    }
  } catch (e) {
...
- Event-driven: SSE push + auto-wake delivers tasks — no polling needed
- Call check_inbox when woken (always returns immediately)
